...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--use_degradation_v2',action='store_true',help='Use v2 degrdation')
        parser.add_argument('--use_degradation_v3',action='store_true',help='Use v3 degrdation')
        self.isTrain = True
        return parser
